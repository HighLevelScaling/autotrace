      ...
      <div className="p-1.5 rounded-[2rem] glass-card h-full">
        <div className="rounded-[calc(2rem-0.375rem)] glass-card-inner p-5 sm:p-6 h-full flex flex-col">
          <div className="flex items-center gap-3 mb-5">
            ...
            <div>
              <h3 className="text-sm font-semibold text-white/90">Ticket History</h3>
          ...
          {tickets.length === 0 ? (
            <div className="flex-1 flex items-center justify-center">
              <p className="text-sm text-white/30">No tickets on record</p>
            </div>
          ) : (
              ...
              {tickets.map((ticket, i) => (
                <div key={ticket.id} className="p-3 rounded-xl bg-white/[0.03] border border-white/[0.05]">
                  ...
                  <div className="mt-2 flex items-center justify-between">
                    ...
                    <span className="text-xs text-white/30">{ticket.points} pts</span>
                  </div>
                </div>
              ))}
            </div>
