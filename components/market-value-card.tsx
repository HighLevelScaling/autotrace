      ...
      <div className="p-1.5 rounded-[2rem] glass-card h-full">
        <div className="rounded-[calc(2rem-0.375rem)] glass-card-inner p-5 sm:p-6 h-full">
          <div className="flex items-center gap-3 mb-5">
            ...
            <div>
              <h3 className="text-sm font-semibold text-white/90">Market Value Estimate</h3>
          ...
          <div className="space-y-3">
            <div>
              <div className="flex justify-between text-xs mb-1.5">
                ...
                <span className="text-white/60">${low.toLocaleString()} — ${high.toLocaleString()}</span>
              </div>
            ...
            <div className="grid grid-cols-3 gap-2 pt-3 border-t border-white/5">
              <div className="text-center p-2 rounded-lg bg-white/[0.03]">
                ...
                <p className="text-sm font-semibold text-white/70 mt-0.5">${low.toLocaleString()}</p>
              </div>
              <div className="text-center p-2 rounded-lg bg-white/[0.03] border border-white/10">
                <p className="text-[10px] text-white/40 uppercase tracking-wider">Mid</p>
                <p className="text-sm font-semibold text-white mt-0.5">${mid.toLocaleString()}</p>
              </div>
              <div className="text-center p-2 rounded-lg bg-white/[0.03]">
                <p className="text-[10px] text-white/40 uppercase tracking-wider">High</p>
                <p className="text-sm font-semibold text-white/70 mt-0.5">${high.toLocaleString()}</p>
              </div>
            </div>
          </div>
        </div>
